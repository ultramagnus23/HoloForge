...
% swap to the real supplemental template before submission if this
% supplement is actually submitted alongside oe_main.tex.
...
\texttt{results\_ablation\_gradients.json}, Fig.~F9a.
...
\RCWAVGridNCases\ cases total) finds \RCWAVGridMaxDev\ maximum deviation,
...
Fig.~F3a. Readout caveat: the compensation cliff (main text, Eq.~5) is a
...
implementation used for all Phase 3 manifests. See Fig.~F9b,
...
rolloff (single seed, single Colab T4 run). See Fig.~F9c,
